...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/franchise.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_big_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/big-slider */ "./src/js/modules/big-slider.js");
/* harmony import */ var _modules_fr_calculator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/fr-calculator */ "./src/js/modules/fr-calculator.js");
/* harmony import */ var _modules_fr_versus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/fr-versus */ "./src/js/modules/fr-versus.js");
...
var frCalculator = new _modules_fr_calculator__WEBPACK_IMPORTED_MODULE_1__["default"]();
var frVersus = new _modules_fr_versus__WEBPACK_IMPORTED_MODULE_2__["default"]();
var identitySlider = new _modules_big_slider__WEBPACK_IMPORTED_MODULE_0__["BigSlider"]("#identity-slider");
var mobileMenu = new _modules_mobile_menu__WEBPACK_IMPORTED_MODULE_3__["default"]();
var yourBshopSlider = new _modules_big_slider__WEBPACK_IMPORTED_MODULE_0__["BigSlider"]("#your-bshop-slider");
...
/***/ "./src/js/modules/fr-calculator.js":
/*!*****************************************!*\
  !*** ./src/js/modules/fr-calculator.js ***!
  \*****************************************/
...
var updateSliderGroup = function updateSliderGroup(slider, position, value) {
  var parent = slider.parentNode;
  var input = parent.querySelector(".fr-calculator__input");
  input.value = position;
};

var calcTax = function calcTax(income, taxType) {
  var taxInMoney = 0;
...
var calcCosmetics = function calcCosmetics(income) {
  var COSMETICS_SHARE = 0.1;
  return parseInt(income * COSMETICS_SHARE);
};

var calcRoyalty = function calcRoyalty(income) {
  var ROYALTY_PERCENT = 5;
  return parseInt(income * ROYALTY_PERCENT / 100);
};

var FrCalculator =
/*#__PURE__*/
function () {
  function FrCalculator() {
    _classCallCheck(this, FrCalculator);

    this.init();
  }

  _createClass(FrCalculator, [{
    key: "init",
    value: function init() {
      var _this = this;

      // Getting franchise calculator form
      this._calcForm = document.querySelector("#fr-calculator");

      if (!this._calcForm) {
        throw new Error("Can't find franchise calculator from");
      } // Getting calculators inputs and polyfill them


      var sliders = this._calcForm.querySelectorAll(".fr-calculator__range");

      sliders.forEach(function (slider) {
        new rangeslider_pure__WEBPACK_IMPORTED_MODULE_0___default.a(slider, {
          polyfill: true,
          // Default CSS classes
          rangeClass: 'rangeslider',
          disabledClass: 'rangeslider--disabled',
          ...
          onSlide: function onSlide(position, value) {
            updateSliderGroup(slider, position, value);
    ...
    value: function initFields() {
      ...
      this._rentInput = this._calcForm.querySelector("#fc-rent");
      this._avgCheckInput = this._calcForm.querySelector("#fc-average-check");
      this._adsCostInput = this._calcForm.querySelector("#fc-ads-cost");
      this._barberShareInput = this._calcForm.querySelector("#fc-barber-share");
      this._clientsNumInput = this._calcForm.querySelector("#fc-clients-num");
      this._expensesInput = this._calcForm.querySelector("#fc-expenses");
      this._receptionInput = this._calcForm.querySelector("#fc-receptionist");
      this._taxInput = this._calcForm.querySelector("#fc-tax");
      this._consumablesInput = this._calcForm.querySelector("#fc-consumables");
      this._acquiringInput = this._calcForm.querySelector("#fc-acquiring");
      this._cosmeticsInput = this._calcForm.querySelector("#fc-cosmetics");
      this._royaltyInput = this._calcForm.querySelector("#fc-royalty");

      this._taxInput.addEventListener("change", function () {
        _this2.calcProfit();
      });
    }
  }, {
    key: "calcProfit",
    value: function calcProfit() {
      // Getting field values
      var rent = parseInt(this._rentInput.value);
      var avgCheck = parseInt(this._avgCheckInput.value);
      var adsCost = parseInt(this._adsCostInput.value);
      var barberShare = parseInt(this._barberShareInput.value);
      var clientsNum = parseInt(this._clientsNumInput.value);
      var expenses = parseInt(this._expensesInput.value);
      var reception = parseInt(this._receptionInput.value); // Calculating profit

      var VISITS_PER_MONTH = 1;
      var EXPENSES_PER_CLIENT = 30;
      var ACQUIRING_PERCENT = 0.8;
      var income = clientsNum * avgCheck * VISITS_PER_MONTH;
      var barbersSalary = income * barberShare / 100;
      var shavingCosts = EXPENSES_PER_CLIENT * clientsNum * VISITS_PER_MONTH;
      this.setConsumables(shavingCosts);
      var acquiring = income * ACQUIRING_PERCENT / 100;
      this.setAcquiring(acquiring);
      var taxInMoney = calcTax(income, this._taxInput.value);
      var cosmetics = calcCosmetics(income);
      this.setCosmetics(cosmetics);
      var royalty = calcRoyalty(income);
      var profit = income - rent - expenses - reception - adsCost - shavingCosts - barbersSalary - taxInMoney + cosmetics - royalty - acquiring;
      this.updateProfit(profit);
    }
  }, {
    key: "setConsumables",
    value: function setConsumables(value) {
      this._consumablesInput.value = value;
    }
  }, {
    key: "setCosmetics",
    value: function setCosmetics(value) {
      this._cosmeticsInput.value = value;
    }
  }, {
    key: "setAcquiring",
    value: function setAcquiring(value) {
      this._acquiringInput.value = value;
    }
  }, {
    key: "updateProfit",
    value: function updateProfit(value) {
      var profitField = this._calcForm.querySelector("#fc-profit");

      profitField.textContent = value + " \u20BD";
    }
  }]);
...
;
/* harmony default export */ __webpack_exports__["default"] = (FrCalculator);

/***/ }),

/***/ "./src/js/modules/fr-versus.js":
/*!*************************************!*\
  !*** ./src/js/modules/fr-versus.js ***!
  \*************************************/
/*! exports provided: default */
...
function () {
  function FrVersus() {
    ...
    _classCallCheck(this, FrVersus);

    this.mobileMoreButton = document.querySelector("#vs-mobile-more");
    this.desktopMoreButton = document.querySelector("#vs-more");
    this.mobileMoreButton.addEventListener("click", function (evt) {
      evt.preventDefault();

      _this.showAllMobile();
    });
    this.desktopMoreButton.addEventListener("click", function (evt) {
      evt.preventDefault();

      _this.showAllDesktop();
    });
  }

  _createClass(FrVersus, [{
    key: "showAllMobile",
    value: function showAllMobile() {
      var contentBlock = document.querySelector(".fr-with-franchise__content");
      contentBlock.classList.toggle("fr-with-franchise__content--shown-mobile");
    }
  }, {
    key: "showAllDesktop",
    value: function showAllDesktop() {
      var comparsonTable = document.querySelector("#vs-quantity");
      comparsonTable.classList.toggle("fr-with-franchise__comparson--closed"); // this.desktopMoreButton.remove();
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (FrVersus);
