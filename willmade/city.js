...
/* harmony import */ var _modules_slider_3d__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slider-3d */ "./src/js/modules/slider-3d.js");
/* harmony import */ var _modules_city_dropdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/city-dropdown */ "./src/js/modules/city-dropdown.js");
/* harmony import */ var _modules_yandex_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/yandex-map */ "./src/js/modules/yandex-map.js");
/* harmony import */ var _modules_mobile_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/mobile-menu */ "./src/js/modules/mobile-menu.js");
/* harmony import */ var _modules_price_table__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/price-table */ "./src/js/modules/price-table.js");
...
var bigSlider = new _modules_big_slider__WEBPACK_IMPORTED_MODULE_0__["BigSlider"]("#features-slider");
var cityDropdown = new _modules_city_dropdown__WEBPACK_IMPORTED_MODULE_2__["default"]();
var mobileMenu = new _modules_mobile_menu__WEBPACK_IMPORTED_MODULE_4__["default"]();
var priceTable = new _modules_price_table__WEBPACK_IMPORTED_MODULE_5__["default"]();
var slider3d = new _modules_slider_3d__WEBPACK_IMPORTED_MODULE_1__["Slider3D"]();
var map = new _modules_yandex_map__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
function () {
  ...
  _createClass(PriceTable, [{
    ...
    value: function addEventsListers() {
      ...
      document.addEventListener('click', function (evt) {
        var priceListRow = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_0__["hasSomeParentOfClass"])(evt.target, 'price-table__row');
...
function () {
  ...
  _createClass(Map, [{
    ...
    value: function addMap() {
      this.map = new ymaps.Map(document.querySelector('.map__map'), {
        center: [54.72320, 20.50786],
        zoom: 16,
        controls: ['zoomControl'],
        ignoreResize: true
      });
      this.map.behaviors.disable(['drag', //   'multiTouch',
      'scrollZoom']); // const marker = new ymaps.Placemark([54.72320, 20.50786]);
      // this.map.geoObjects.add(marker);

      var logoMarker = new ymaps.Placemark([54.7233, 20.5077], {}, {
        // Опции.
        // Необходимо указать данный тип макета.
        iconLayout: 'default#image',
        // Своё изображение иконки метки.
        // iconImageHref: 'img/spot.png',
        iconImageHref: 'img/marker--single.svg',
        // Размеры метки.
        iconImageSize: [58, 75],
...
/* harmony default export */ __webpack_exports__["default"] = (Map); // todo
